        ...
        <div className="flexCenter property-details">
            ...
            <div className="flexColStart left">
              ...
              <div className="flexStart facility">
                ...
                <span className="secondayText" style={{textAlign: 'center'}}>
                    {data?.description}
                </span>
...

               {
                bookings?.map((booking) => booking.id).includes(id) ? (
                    ...
                    <span>
                        Your visit already been booked for date {bookings.filter((booking)=> booking?.id === id)[0].date}
                    </span>
                    </>
                ) : (
            ...
            <div className="map">
                    <CustomMap address = {data.address} city = {data.city} country={data.country}/>
                </div>
        </div>
       </div>
    </div>
